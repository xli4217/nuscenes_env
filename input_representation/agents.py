...
def draw_agent_boxes(center_agent_annotation: Dict[str, Any],
    ...
    if ego:
        ...
        ## dummy annotation
        ego_ann = {
            'token': '49f76277d07541c5a584aa14c9d28754',
            'sample_token': 'ca9a282c9e77460f8360f564131a8af5',
            'instance_token': 'c1958768d48640948f6053d04cffd35b',
            'visibility_token': '4',
            'attribute_tokens': ['cb5118da1ab342aa947717dc53544259'],
            'translation': [399.863, 1143.574, 0.738],
            'size': [1.907, 4.727, 1.957],
            'rotation': [-0.576881477903537, 0.0, 0.0, 0.816827864639687],
            'prev': '',
            'next': 'ae589a5a2bdb4813ae8021cd51b7e6eb',
            'num_lidar_pts': 15,
            'num_radar_pts': 1,
            'category_name': 'vehicle.car'}

        if ego_pose is not None:
            center_agent_annotation['translation'] = ego_pose['translation']
            center_agent_annotation['rotation'] = ego_pose['rotation']
            agent_x, agent_y = ego_pose['translation'][:2]
        ego_ann['translation'] = center_agent_annotation['translation']
        ego_ann['rotation'] = center_agent_annotation['rotation']
        ego_ann['instance_token'] = None
        box = get_track_box(ego_ann, (agent_x, agent_y), center_agent_pixels, resolution)
        color = (255,0,0)
